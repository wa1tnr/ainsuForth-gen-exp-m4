...
void setup_spi_flash(void) {
  ...
  Serial.println("Line 128 seen."); // debug may 2018
  ...
  if (!fatfs.begin()) {
    ...
    Serial.println("\r\n\r\n");
    Serial.println("WARNING: flash chip not identified!  Do not try to write.");
    // while(1); // debug - want this hold as a trap for faults
  }
